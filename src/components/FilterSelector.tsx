...
export function FilterSelector() {
  ...
  return (
    <div className="grid w-full grid-cols-3 sm:flex sm:flex-row items-center gap-4">
      <Select value={difficulty || ''} onValueChange={handleDifficultyChange}>
        <SelectTrigger className="w-full max-w-[200px] rounded-full ring-2 ring-offset-2 ring-gray-300 border-none px-4 py-1 h-7">
