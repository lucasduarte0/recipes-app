...
import { X as RemoveIcon, XCircle } from 'lucide-react';
    ...
    return (
      <TagInputContext.Provider
        ...
        <div
          ...
          dir={dir}
          className={cn(
            'flex items-center flex-wrap gap-1 py-3 px-3 rounded-lg bg-background overflow-hidden   ring-1 ring-input  ',
            {
          ...
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed"
              )}
              variant={'secondary'}>
              ...
              <button
                ...
                <XCircle className="h-4 w-4 hover:stroke-destructive" />
              </button>
            </Badge>
          ))}
          <Input
